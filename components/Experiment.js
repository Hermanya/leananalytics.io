...
export const Experiment = ({ experiment, className, onDelete, onUpdate, ...props }) => {
        ...
        <div className="d-flex align-items-center justify-content-between mb-2 flex-wrap">
          ...
          <span>
            ...
            >
              ...
              {tooltip === 'delete' && 
                <div className="bg-dark text-white p-2 position-fixed rounded animated fadeInDown faster" style={{ marginLeft: -24 }}>
                  delete
                </div>}
            </button>          
          </span>        
